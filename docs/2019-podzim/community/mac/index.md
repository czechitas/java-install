...
Archív s instalací si můžete stáhnout zde: [Java-Training.zip](https://github.com/czechitas/java-install/releases/download/2019-podzim/community/mac/Java-Training.zip).
