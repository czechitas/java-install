...
1.  Stáhněte si instalátor
    [Java-Training_setup.exe](https://github.com/czechitas/java-install-dist/releases/download/2019-podzim/community/win/Java-Training_setup.exe)

14. Najděte na počítači uložený soubor `Java-Training_setup.exe` (pravděpodobně je ve složce
    `Downloads`) a spusťte ho.

    ![](img/img12a.png)

15. Budete upozorněni, že instalátor není digitálně podepsán. To není problém. Schvalte výjimku.

    ![](img/img12b.png)

15. ![](img/img12c.png)

15. Pokud by nešlo výjimku pro instalátor schválit, přejďete na ruční [rozbalení archívu](#alternative-archive). Jinak pokračujte zde.
...
16. Instalace je hotová.

Pokračujte na vyzkoušení, zda [instalace funguje](#test).



### <a id="alternative-archive">Alternativní postup místo instalátoru</a>

V případě, že by vám instalátor nešel spustit, můžete použít manuální instalaci rozbalením archívu s programy.<br/>
Pokud vám instalátor spustit šel, přeskočte na [test instalace](#test).
